...
if [ -n "$bed" ]; then
    java -jar $TOOLS_PATH/SNVerIndividual.jar -b 0.05 -mq 0 -bq 0 -a 1 -i $bam -r $ref -l $bed -o $out/$name 
else
    java -jar $TOOLS_PATH/SNVerIndividual.jar -b 0.05 -mq 0 -bq 0 -a 1 -i $bam -r $ref -o $out/$name
fi
